...
class CategorySettingsActivity final : public ActivityWithSubactivity, public navigation::Menu {
  ...
  const std::function<void()> onHardwareBack;
  ...
  static constexpr int kMainListTopOffset = 30;
  static constexpr int kEmbeddedListTopExtra = 30;
 ...
 public:
  CategorySettingsActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, const char* categoryName,
                           ...
                           std::function<void()> indexLibraryHandler = nullptr, const char* backLabel = nullptr,
      ...
      : ActivityWithSubactivity("CategorySettings", renderer, mappedInput),
        ...
        onGoBack(onGoBack),
        onHardwareBack(std::move(hardwareBackHandler)),
    ...
    itemsPerPage = (contentBottom - contentTop) / Page::LIST_ITEM_HEIGHT;
  ...
  bool isDetailOpen() const { return embedded && (groupOpen || selectorOpen || subActivity != nullptr); }
};
